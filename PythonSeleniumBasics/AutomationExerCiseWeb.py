...
driver.find_element(By.XPATH,value="//input[@data-qa='signup-name']").send_keys("TamilK")
driver.find_element(By.XPATH,value="//input[@data-qa='signup-email']").send_keys("TamilK@gmail.com")
...
driver.find_element(By.XPATH,value="//input[@data-qa='last_name']").send_keys("Kumar")
driver.find_element(By.XPATH,value="//input[@data-qa='address']").send_keys("Salem,Bypass")
...
driver.find_element(By.XPATH,value="//input[@data-qa='mobile_number']").send_keys("9876543210")
driver.find_element(By.XPATH,value="//button[@data-qa='create-account']").click()
accsuccess=driver.find_element(By.XPATH,value="//h2[@data-qa='account-created']").text
